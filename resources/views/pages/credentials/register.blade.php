            ...
            <div class="col-span-2">
                <div class="container mx-auto w-10/12 lg:mt-10 mb-16 bg-white shadow-lg rounded">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="p-8 px-6 mr-4 lg:px-2">
                            ...
                            @error('login')
                            <div class="flex items-center mt-4 rounded bg-blue-500 text-white text-md font-semibold px-4 py-3" role="alert">
                            ...
                            <form action="/registration" method="POST" class="mt-4">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-8">
                                    <div class="relative z-0 w-50 mb-5">
                                        <input type="text" name="firstname" id="firstname" placeholder=" " value="{{ old('firstname') }}" class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-green-800 border-gray-500">
                                    ...
                                    <div class="relative z-0 w-50 mb-5">
                                        <input type="text" name="lastname" id="lastname" placeholder=" " value="{{ old('lastname') }}" class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-green-800 border-gray-500">
                                ...
                                <div class="relative z-0 w-full mb-5" x-data="{ show: true }">
                                    <input :type="show ? 'password' : 'text'" name="password_confirmation" id="password_confirmation" placeholder=" " class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-green-800 border-gray-500" />
                                ...
                                <div class="relative z-0 w-full mb-5">
                                    <button type="submit" class="bg-green-800 text-white p-3 w-full font-bold hover:dark:bg-green-900">Register</button>
                                </div>
                                <a href="/forgot" class="content-end text-green-800 hover:underline">Forgot Password ?</a>
                                <div class="mt-10 text-justify text-gray-600">
