<div class="fixed text-white dark:bg-gray-900 h-full w-64 hidden lg:block float-left transition duration-200 shadow-md z-50" id="sidebar">
    
    @foreach ($userSiderbar as $item)
